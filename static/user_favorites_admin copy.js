...
async function initializePage() {
    if (isAuthContextReady && isDomContentLoaded) {
        ...
        // Assign DOM Elements for hamburger menu
        hamburgerBtn = document.getElementById('hamburger-btn');
        adminNavDropdown = document.getElementById('admin-nav-dropdown');

        // Basic check for essential elements
        if (!document.getElementById('status-message-area') || !document.getElementById('save-all-button') || !hamburgerBtn || !adminNavDropdown) {
